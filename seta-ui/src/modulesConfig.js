...
export const appModules = [
    ...
    {
        id: 'verify-result',
        name: 'Verification Result', // Name used internally or for debugging
        path: '/verify-result', // The path the backend redirects to
        component: React.lazy(() => import('./modules/VerificationResultPage')), // Lazy load the new component
        isPublic: true, // This page needs to be accessible without login
        isMenuItem: false, // Don't show in the sidebar
    },
