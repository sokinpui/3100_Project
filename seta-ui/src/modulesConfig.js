...
export const appModules = [
  ...
  // --- Protected Routes (will appear in sidebar if icon is provided) ---
  {
    ...
    component: React.lazy(
      () => import("./modules/DynamicDashboard/DynamicDashboard"),
    ),
    isProtected: true,
    icon: <DashboardIcon />,
  },
  {
    ...
    component: React.lazy(
      () => import("./modules/ExpenseManager/ExpenseManager"),
    ),
    isProtected: true,
  ...
  },
  {
    ...
    component: React.lazy(
      () => import("./modules/IncomeManager/IncomeManager"),
    ),
    isProtected: true,
  ...
  },
  {
    ...
    component: React.lazy(
      () => import("./modules/AccountManager/AccountManager"),
    ),
    isProtected: true,
  ...
  },
  {
    ...
    component: React.lazy(
      () => import("./modules/RecurringManager/RecurringManager"),
    ),
    isProtected: true,
  ...
  },
  {
    ...
    component: React.lazy(
      () => import("./modules/PlanningManager/PlanningManager"),
    ),
    isProtected: true,
  ...
  },
  {
    ...
    path: "/custom-reports",
    component: React.lazy(
      () => import("./modules/CustomReport/CustomReport.jsx"),
    ),
  ...
  },
  {
    ...
    component: React.lazy(
      () => import("./modules/ExpenseImport/ExpenseImport"),
    ),
    isProtected: true,
